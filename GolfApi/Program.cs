...
internal class Program
{
    private static void Main(string[] args)
    {
        ...
        builder.Services.AddDbContext<BgContext>(options => options.UseNpgsql("User ID=postgres;Password=Alfonsina22;Host=localhost;Port=5101;Database=BetterGolf;Pooling=true;Connection Lifetime=0;"));
