...
export function CategoriesFormPage() {    
	...
	if (params.id) {
	    ...
	    // se supone que los usuarios van a venir de tournamentFormPage,
	    // una manera de enviarlos denuevo seria navigate(-1)
	}
    });
    ...
    //
    // la idea del coso de abajo es que tenga los courses de verdad, y
    // que solo muestre para alterar los courses de ladies si es que es una 
    // de ladies,
    // 
    //
    //
