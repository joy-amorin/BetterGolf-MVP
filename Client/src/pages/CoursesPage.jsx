  ...
  return (
    <div className="w-80%">
      ...
      <div className="flex flex-wrap gap-4 mt-10 w-100%  ">
        {courses.map((course) => (
          <Card className="py-1 w-40% mb-10 ml-11 bg-gradient-to-b from-blue-700 via-blue-800 to-gray-900" key={course.id}
          >
            
            <CardHeader onClick={ async () => {navigate(`/courses/${course.id}/`)}} className="pb-1 pt-0 px-2 display-flex flex-row border-b border-1">
              
              <p className="text-2xl text-black-500 text-center">{course.name} </p>
    ...
    <div className=" align-content: flex-start;">
                <Dropdown>
      <DropdownTrigger>
        <Button 
          variant="shadow"
