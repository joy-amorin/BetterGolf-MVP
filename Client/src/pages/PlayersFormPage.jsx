		...
		<div className="max-w-xl mx-auto">
			<form onSubmit={onSubmit}>
				...
				<div className="flex w-full flex-wrap md-flex-nowrap gap-4 mb-3">
					<Select placeholder={errors.sex ? "Required" : "Select sex"} label="Sex" className="max-w-xs">
				...
				<Button color="primary" type="submit" onClick={() => {if (!params.id){onclose()}else{cambiarValor}}}>
					Save
				</Button>
			</form>
			{params.id && (
